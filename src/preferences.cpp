...
namespace prefs
{
	namespace guids
	{
		...
		static constexpr GUID check_write_original_date = { 0x319aec18, 0x49dc, 0x45cb, { 0x9c, 0xee, 0xf0, 0x46, 0xf8, 0x20, 0x7e, 0x68 } };
	...
	namespace defaults
	{
		...
		static constexpr bool check_write_original_date = true;
	...
	namespace check
	{
		...
		cfg_bool write_original_date(guids::check_write_original_date, defaults::check_write_original_date);
...
namespace mb
{
	...
	public:
		...
		BOOL OnInitDialog(CWindow, LPARAM)
		{
			...
			m_check_map[IDC_CHECK_WRITE_ORIGINAL_DATE] = { &check::write_original_date, defaults::check_write_original_date };
